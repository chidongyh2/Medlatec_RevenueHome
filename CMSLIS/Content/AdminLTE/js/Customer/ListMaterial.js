...
function ConfirmAdd() {
    ...
    var selectedValue1 = ProducerID.value;
    window.location.href = "/CatalogSystem/ListMaterialAdd?ProducerID=" + selectedValue1 + "&MaterialCateID=" + selectedValue;
    return true;
}
            ...
            buttons: {
                specialKey: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/CatalogSystem/ListMaterialDelete",
            ...
            buttons: {
                specialKey: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/CatalogSystem/ListMaterialPublic",
                            data: JSON.stringify(selectedIDs),
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            headers: {
